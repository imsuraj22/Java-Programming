...
public class GamePanel implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent e)
    {
      ...
      if(player1_turn==true)
      {
          ...
          title="0";
          jf.setTitle(player2+" ("+title+") turns");
          player1_turn=false;
      }
      else
      {
          ...
          title="X";
          jf.setTitle(player1+" ("+title+") turns");
          player1_turn=true; 
      }
      if(e.getSource()==jb1)
      {
    ...
    void whoWins()
    {
        if(win==true)
        {
            ...
            String win_title=player_who_wins+" ("+xo_symbol+") "+"wins";
    ...
    void restartGame()
    {
        if(total_series>=series_count)
        {
            ...
            if(i==0)
            {
                ...
                jf.setTitle(player_who_wins+"("+xo_symbol+") turns ");
