...
public class NotepadApplication implements ActionListener
{
    ...
    void start()
    {
       ...
       Image icon= Toolkit.getDefaultToolkit().getImage("D:\\java\\11. Notepad editor\\notepad editor\\notepadeditor_lyst2319\\notepadeditor\\notepad_icon.png");
       ...
       file.add(neww);
        ...
        word_wrap = new JCheckBoxMenuItem("Word_Wrap");
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        NotepadApplication np = new NotepadApplication();
        np.start();
